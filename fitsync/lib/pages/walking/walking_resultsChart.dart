...
class WalkingResultsPageChart extends StatelessWidget {
  final String duration;
  final String distance;
  final String calories;

  const WalkingResultsPageChart({
    Key? key,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildMapChart(context, screenHeight),
              const SizedBox(height: 20),
              _buildWeather(),
              const SizedBox(height: 20),
              _buildNotes(),
  ...
  Widget _buildMapChart(BuildContext context, double screenHeight) => Padding(
