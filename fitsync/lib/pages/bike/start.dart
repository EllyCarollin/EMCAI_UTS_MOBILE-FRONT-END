...
class CyclingStart extends StatelessWidget {
  const CyclingStart({super.key});
...
class FirstRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: double.infinity, // supaya full width
      height: double.infinity, // supaya memenuhi layar
      child: Image.asset(
        'assets/map.png',
        fit: BoxFit.cover, // gambar akan scale biar nutup layar
      ),
    );
  }
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Deskripsi di bawah
            const Text(
              "Boost your cycling workout with a target.",
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) =>
                              CyclingStop(), // Change to the correct stop page for cycling
                    ),
                  );
                },
