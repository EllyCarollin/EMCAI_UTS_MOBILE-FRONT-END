...
import 'package:fitsync/pages/jumprope/stop.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class JumpropeStart extends StatelessWidget {
  const JumpropeStart({super.key});
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const JumpropeStop(),
                    ),
                  );
                },
