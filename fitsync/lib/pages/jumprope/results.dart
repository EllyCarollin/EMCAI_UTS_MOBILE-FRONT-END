                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          calories, // Menampilkan kalori yang diterima dari stop.dart
                        ...
                        Text(
                          duration, // Menampilkan durasi yang diterima dari stop.dart
                          style: const TextStyle(
                            fontSize: 16,
                            color: Colors.blue,
                            fontWeight: FontWeight.bold,
                    ...
                    const SizedBox(height: 8),
                    Text(
                      jumpCount, // Menampilkan kalori yang diterima dari stop.dart
                      style: const TextStyle(
                        fontSize: 16,
                        color: Colors.red,
                        fontWeight: FontWeight.bold,
